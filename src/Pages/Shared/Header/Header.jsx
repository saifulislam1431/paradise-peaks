            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex items-center md:order-2">
                    ...
                    <div className={`z-50 ${menuOpen ? " absolute top-16 right-7" : "hidden"} my-4  text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}>
                        <div className="px-4 py-3">
                            <span className="block text-sm font-medium text-gray-900 dark:text-white">{user ? user.displayName : 'Empty'}</span>
                            <span className="block text-sm font-medium  text-gray-500 truncate dark:text-gray-400">{user?user.email:"empty"}</span>
                        </div>
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <NavLink to="/" className="block py-2 pl-3 pr-4 hover:text-gradient-primary  md:p-0 " aria-current="page">Home</NavLink>
                        </li>
                        <li>
                            <NavLink to="/about" className="block py-2 pl-3 pr-4 hover:text-gradient-primary rounded md:p-0 ">About</NavLink>
                        </li>
                        <li>
                            <NavLink to="/services" className="block py-2 pl-3 pr-4 hover:text-gradient-primary rounded md:p-0 ">Services</NavLink>
                        </li>

                        <li>
                            <NavLink to="/contact" className="block py-2 pl-3 pr-4 hover:text-gradient-primary rounded md:p-0 ">Contact</NavLink>
                        </li>
                    </ul>
                </div>
            </div>
